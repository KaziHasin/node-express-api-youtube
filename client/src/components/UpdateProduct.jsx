        ...
        <div className='fixed inset-0 flex items-center justify-center'>
            ...
            <div className='bg-white p-6 rounded-lg z-10 max-w-xl w-full'>
                ...
                <form onSubmit={handleSubmit} className='mt-4 text-start'>
                    <div className='mb-3'>
                        <label htmlFor="product-name" className='text-lg font-semibold text-gray-500 mb-2'>Product Name</label>
                    ...
                    <div className='mb-3'>
                        <label htmlFor="product-price" className='text-lg font-semibold text-gray-500 mb-2'>Product Price</label>
